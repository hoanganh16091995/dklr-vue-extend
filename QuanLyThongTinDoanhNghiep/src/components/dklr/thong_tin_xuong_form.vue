    ...
    <v-form
      ...
      <div class="ml-0">
        <v-layout row wrap class="ml-0">
          ...
          <v-flex xs12 sm12 class="pt-2" v-if="thongTinXuong['productionPlantCOP']">
            <label>Mã xưởng: <span style="color: red;">(*)</span></label>
            <v-text-field
              outline
              :disabled="true"
              v-model="thongTinXuong['productionPlantCOP']"
              placeholder="Nhập mã xưởng sản xuất, lắp ráp"
              clearable
              class="py-0 pr-1"
              :class="{'track-change': isChange('productionPlantCOP')}"
              required
          ...
          <v-flex xs12 sm12 class="pt-2">
            <label>Tên xưởng sản xuất, lắp ráp: <span style="color: red;">(*)</span></label>
            <v-text-field
              outline
          ...
          <v-flex xs12 sm12>
            <label>Địa điểm sản xuất (Theo Giấy chứng nhận đăng ký doanh nghiệp / chứng nhận đăng ký kinh doanh/ chứng nhận đầu tư): <span style="color: red;">(*)</span></label>
            <v-text-field
              outline
              :disabled="disabledForm"
          ...
          <v-flex xs12 sm12>
            <label>Loại giấy chứng nhận: <span style="color: red;">(*)</span></label>
            <v-radio-group v-model="thongTinXuong['productionPlantIdentityType']" column class="ml-5" required
              ...
              <v-radio label="Giấy chứng nhận đăng ký địa điểm kinh doanh" value="4"></v-radio>
              <v-radio label="Giấy chứng nhận đăng ký hoạt động chi nhánh" value="5"></v-radio>
            </v-radio-group>
          </v-flex>
          ...
          <v-flex xs12 sm12>
            ...
            <span v-if="thongTinXuong['productionPlantIdentityType'] === 2 || thongTinXuong['productionPlantIdentityType'] === '2'">Giấy chứng nhận đăng ký doanh nghiệp:</span>

            <span v-else-if="thongTinXuong['productionPlantIdentityType'] === 1 || thongTinXuong['productionPlantIdentityType'] === '1'">Giấy chứng nhận đăng ký kinh doanh:</span>

            <span v-else-if="thongTinXuong['productionPlantIdentityType'] === 3 || thongTinXuong['productionPlantIdentityType'] === '3'">Giấy chứng nhận đầu tư:</span>

            <span v-else-if="thongTinXuong['productionPlantIdentityType'] === 4 || thongTinXuong['productionPlantIdentityType'] === '4'">Giấy chứng nhận đăng ký địa điểm kinh doanh:</span>
          ...
          <v-flex xs12 sm8>
            <v-layout row wrap class="ml-0">
              ...
              <v-flex xs12 sm3 class="text-xs-center">
                ...
                <v-chip label :disabled="!thongTinXuong['productionPlantIdentityFileEntryId'] || thongTinXuong['productionPlantIdentityFileEntryId'] === '0'" v-else style="cursor: pointer; pointer-events: auto;" outline color="blue" @click="xemGCNDangKy()">
                  <v-icon
                    size="17"
                    style="font-size: 15px"
                    :color="thongTinXuong['productionPlantIdentityFileEntryId'] && thongTinXuong['productionPlantIdentityFileEntryId'] !== '0' ? 'green' : 'red'
                    "
                    >
                    {{
                      thongTinXuong['productionPlantIdentityFileEntryId'] && thongTinXuong['productionPlantIdentityFileEntryId'] !== '0' ? "done" : "cancel"
                    }}
                  </v-icon>
                  Xem GCN
          ...
          <v-flex xs12 sm4>
            ...
            <v-text-field
              ...
              clearable
              class="py-0 pr-1"
              :class="{'track-change': isChange('productionPlantissuedate')}"
            ></v-text-field>
          </v-flex>
...
export default {
  ...
  created () {
    ...
    vm.$nextTick(function () {
      ...
      console.log('productionPlantMetadata+++++++++', vm.thongTinXuong['productionPlantMetadata'])
      if (vm.thongTinXuong['productionPlantMetadata']) {
        vm.dataNguoiDaiDienItems = JSON.parse(vm.thongTinXuong['productionPlantMetadata']) || []
      }
  ...
  methods: {
    ...
    xemGCNDangKy () {
      let vm = this
      if (!vm.thongTinXuong['productionPlantIdentityFileEntryId'] || vm.thongTinXuong['productionPlantIdentityFileEntryId'] === '0') {
        console.log('ko có productionPlantIdentityFileEntryId')
        return
      }
      vm.$store.dispatch('getFileGCN', {
        fileEntryId: vm.thongTinXuong['productionPlantIdentityFileEntryId'] || 0
      }).then(result => {
