...
export const store = new Vuex.Store({
  ...
  actions: {
    ...
    loadDetailCSSX ({commit, state}, data) {
      return new Promise((resolve, reject) => {
        store.dispatch('loadInitResource').then(function (result) {
          let config = {
            headers: {
          ...
          let url = '/o/rest/v2/dictcollections/VR86/dictitems/' + data['itemCode']
    ...
    getFileGCN ({commit, state}, data) {
      return new Promise((resolve, reject) => {
        store.dispatch('loadInitResource').then(function (result) {
          ...
          let url = '/o/rest/v2/dossiers/fileEntryId/' + data['fileEntryId']
          axios.get(url, config).then(function (response) {
            var serializable = response.data
            var url = window.URL.createObjectURL(serializable)
            resolve(url)
          }).catch(function (xhr) {
            reject(xhr)
          })
    ...
    xacNhanPtCapPhieu ({commit, state}, data) {
      return new Promise((resolve, reject) => {
        store.dispatch('loadInitResource').then(function (result) {
          var configXncp = {
            headers: {
          ...
          axios.put('/o/rest/vr-app/methodofissue/update', data, configXncp).then(function (response) {
            let serializable = response.data
            resolve(serializable)
          }).catch(function (xhr) {
            console.log(xhr)
    ...
    loadDSItemsPtCapPhieuXX ({commit, state}, data) {
      return new Promise((resolve, reject) => {
        store.dispatch('loadInitResource').then(function (result) {
          var url = '/o/rest/vr-app/methodofissue'
          var configDSCoSoNuocNgoai = {
            headers: {
              groupId: state.initData['groupId']
            },
    ...
    loadLoaiHinh ({commit, state}, data) {
      return new Promise((resolve, reject) => {
        store.dispatch('loadInitResource').then(function (result) {
          let urlRequest = '/o/rest/v2/dictcollections/VR92/dictitems'
          let param = {
            headers: {
              groupId: state.initData['groupId']
            },
    ...
    loadCanCu ({commit, state}, data) {
      return new Promise((resolve, reject) => {
        store.dispatch('loadInitResource').then(function (result) {
          let urlRequest = '/o/rest/v2/dictcollections/VR94/dictgroups/' + data['code'] + '/dictitems'
          let param = {
            headers: {
              groupId: state.initData['groupId']
            },
    ...
    countDN ({commit, state}, data) {
      return new Promise((resolve, reject) => {
        store.dispatch('loadInitResource').then(function (result) {
          let urlRequest = '/o/rest/vr-app/applicant/profile/count'
          let param = {
            headers: {
              groupId: state.initData['groupId']
            },
